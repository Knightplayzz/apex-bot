    ...
    async execute(interaction, auth) {
        if (interaction.isChatInputCommand()) {
            ...
            if (slashCommand.premium == true) {
                ...
                userEntitlements.forEach(async data => { if (data.skuId === '1246777340806303866') isUserPremium = true }); //|| data.skuId === '1014207340188270673' THIS IS USER SUBSCRIPTION
                entitlements.forEach(async data => { if (data.skuId === '1247194389281902683' || data.skuId === '1246772758541631518') isServerPremium = true; }) //LIFETIME 1247194389281902683| sub 1246772758541631518
