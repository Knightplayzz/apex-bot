...
module.exports = {
    ...
    async execute(interaction, auth, userData) {
        ...
        const data = await fetchJson(url, {
            cacheKey: 'apex:predator',
            cacheTtlMs: 60 * 1000,
            label: 'Apex predator cap',
            timeoutMs: 10_000,
        ...
        const predatorEmbed = new EmbedBuilder()
            ...
            .setDescription(
                `**${lang[langOpt].predator.line_2}:** <t:${data.RP.PC.updateTimestamp}:R>`
            )
            .addFields([
                {
        ...
        return interaction.editReply({ embeds: [predatorEmbed], ephemeral: userData.invisible });
    },
};
